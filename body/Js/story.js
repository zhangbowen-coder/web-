...
var story=
{
	...
	"j3_1":{
		...
		"bgi":"../../resource/游戏背景图/中国朝鲜指挥部.png",//背景图片路径,没有就是空串
		"ptr":0
	},
	"j3A_1_1":{
	...
	"j3A_1_4":{
		...
		"bgi":"../../resource/游戏背景图/中国朝鲜指挥部.png",//背景图片路径,没有就是空串
		"chara":["../../resources/人物立绘/中国参谋4.jpg","../../resources/人物立绘/彭国辉.png"],//人物立绘路径，没有就是空串
	...
	"j4_2":{
		...
		"content":
			[
				"面对十三国提案，是打击帝国主义嚣张气焰，还是休整部队，防守反击？",
				"响应和平提案，利用时间整顿后勤，先停火在谈判",
				"质疑和平提案，率领军队跨过三八线，敌退我追",
			],
		"bgi":"../../resource/游戏背景图/中国朝鲜指挥部.png",//背景图片路径,没有就是空串
	...
	"j4B_2_2":{
		...
		"content":
			[
				...
				["video/webm","../../resources/视频/webm格式/决策4B进决策5选B.webm"],
			],
		"ptr":0,
	...
	"situation3_j8A_1_2":{
		...
		[
			...
			["video/mp4","../../resources/视频/webm格式/双方对峙.webm"]
		],
	...
	"j1a_1_2": {
		"type": "single",//页面类型，参见上面的forms变量的字符串
			"content":
		[
			[0,"彭德辉","主席，这几个月我之前遗留下来的伤更加严重了，希望能留在后方养精蓄锐，我国将星辈出，必有他人堪当此大任"]
	...
	"j1b_1_1": {
		"type": "single",//页面类型，参见上面的forms变量的字符串
			"content":
		[
			[0,"彭德辉","保家卫国，无需多言，主席你就安心交给我，我一定会打败米帝，取得胜利！"]
	...
	"j1b_1_5": {
		"type": "paper",//页面类型，参见上面的forms变量的字符串
			"content":
		[
			[0,"彭德辉", "沉思）敌军现在如此看待战场局势，我军接下来该如何应对——"]
		],
	...
	"j2a_1_1": {
		"type": "single",//页面类型，参见上面的forms变量的字符串
			"content":
		[
			[0,"彭德辉", "怀伍斯塔不是很狂妄吗？不是不相信我们的大部队已经过江了吗？我们就利用他这个判断失误，示敌以弱 诱敌深入，然后找到机会歼灭之!"]
	...
	"j2b_1_3": {
		...
		[
			...
			[1, "彭德辉", "摇摇头）敌军力量比我们想象的要更强，命令部队好好休整，这将是一场硬仗！"]
	...
	"j2c_1_1": {
		"type": "single",//页面类型，参见上面的forms变量的字符串
			"content":
		[
		[0,"彭德辉", "怀伍斯塔这是公开嘲笑我军兵力不足！我们不能示弱退缩，要堂堂正正地与米军交锋到底！"]
  ...
  "j4b_j5a_1_2": {
    ...
    "content":
      [
        ["video/mp4", "../../resources/视频/决策4B进决策5选A.mp4"],
        ["video/mp4", "../../resources/视频/webm格式/决策4B进决策5选A.webm"],
      ],
    "next": ["situation2"],
    "ptr": 0
  },
  ...
  "situation3": {
	...
	"situation2_2":{
		...
		"content":
		[
		[0,"将军,在上次战争中我们保留了大部分作战力量,敌人也损失惨重"],
		[1,"我已经提前命令军队保存实力，让南新罗军队充当炮灰，现在两军的力量对比已经发生转变，我们应当着手下一个计划"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/","../../resources/人物立绘/"],
		"ptr":0,
		"next":["situation2_j9"]
	},
	"situation2_j9_1":{
	...
	"situation1_2":{
		...
		"content":
		[
		[0,"将军，在上次战争中我们保留了大部分作战力量，敌人后勤情况非常差，且海军也已经准备完毕，可以进行登陆作战"],
		[1,"根据我的观察，虽然敌人获得了战役胜利，但是随着我军的进一步集结，现在两军的力量对比已经发生转变，我们应当着手下一个计划"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/参谋","../../resources/人物立绘/马克"],
		"ptr":0,
		"next":["situation1_j10"]
	},
	"situation1_j10_1":{
	...
	"situation2_j9B_1_2":{
		...
		"content":
		[
		[0,"好一个“月圆攻势”和“礼拜攻势”啊，这次我们可不会再重蹈覆辙了！"],
		[0,"我军现已经休整完毕，恢复了作战能力，虽尚未完全集结，但机动力量已严整待发——————"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
	...
	"situation2_j9B_1_j11B_1_1":{
		...
		"content":
		[
		[0,"进行猎犬行动，派出所有侦查队，行军向北侦查，直到发现共和国军的真正的防御线为止，用这些小股部队缠住敌人，不要让他们轻易脱身！"],
		[0,"哈哈，这招终于抓住了共和国军的弱点！"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/马克"],
	...
	"situation2_j9B_1_j11B_1_3":{
		...
		"content":
		[
		[0,"我们缠住了敌军，敌军现在难以抽身，我们应当决定如何进军——————"],
		[0,"据我所知前任指挥官沃克是采取了集中进军，沿公路线前进——————"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/马克"],
		"ptr":0,
	...
	"situation2_j9A_1_1":{
		...
		"content":
		[
		[0,"在之前的战斗联军实力有所削弱，我军需要趁机好好休整，做好战斗准备"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/马克"],
		"ptr":0,
	...
	"situation2_j9A_1_2":{
		...
		"content":
		[
		[0,"我军经修整后兵力充足，蓄势待发，现在我军战斗力事实上已经超过共和国军"],
		[0,"虽尚未完全集结，但机动力量已严整待发"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/马克"],
		"ptr":0,
	...
	"situation1_j10B_1_2":{
		...
		"content":
		[
		[0,"报告，将军！我们已经发现敌人的两大作战特点，准备针对其进行作战，但我军前线尚未完成集结。我们是否要等待集结完成进而发动猛烈进攻？"],
		[1,"我军虽未完成集结，但机动力量已严整待发——————"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/参谋","../../resources/人物立绘/马克"],
		"ptr":0,
	...
	"situation1_j10A_1_1":{
		...
		"content":
		[
		[0,"在之前的战斗联军实力有很大削弱，我军需要趁机好好休整，做好战斗准备。"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/马克"],
		"ptr":0,
	...
	"situation1_j10A_1_2":{
		...
		"content":
		[
		[0,"报告，将军！我军已经休整完毕，已经恢复了作战能力，但尚未完全集结。我们是否要等待集结完成进而发动猛烈进攻？"],
		[1,"我军虽未完成集结，但机动力量已严整待发——————"]
		],
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.jpg",
		"chara":["../../resources/人物立绘/参谋","../../resources/人物立绘/马克"],
	...
	"j11_B_1_j12_B_1_1":{
		...
		"content":
		[
			"克集中进军的战术总是被共和国军的分割包围战术所反制，我军的兵力经穿插包围后又陷入了苦战",
	...
	"j12_A_1":{
		...
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.png",
		"chara":["../../resources/人物立绘/马克.png","../../resources/人物立绘/"],
		"ptr":0,
		"next":["j13_1"]
	},
	"j13_1":{
	...
	"j13_B_1_3":{
		...
		[
			...
			[1,"参谋","前线来报，敌军正在向北撤军，我们需要追击嘛？"],
			[0,"马克","追击！乘胜追击！"]
		],
		"chara":["../../resources/人物立绘/马克.png","../../resources/人物立绘/美国参谋.png"],
		"ptr":0,
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.png",
		"next":["j13_B_1"]
	},
	"j13_B_1":{
		...
		"content":
		[
			[1,"参谋","敌军向北逃窜，战线漫长，我军是否要制定一个主攻方向？"]
			[0,"马克","当然，我们要集中一点全力突破，发挥我军强大的火力优势"]
		],
		"chara":["../../resources/人物立绘/马克.png","../../resources/人物立绘/美国参谋.png"],
		"ptr":0,
		"bgi":"../../resources/游戏背景图/美军朝鲜指挥部.png",
